        ...
        projects: {
            ...
            research: {
                cimav: {
                    ...
                    description: "Chatbot hecho en React con FastAPI que permite hacer busquedas sobre todas las tesis y papers relacionados a doctores, maestros y estudiantes del CIMAV",
                    highlights: [
                        'Chatbot con interfaz responsiva y moderna',
        ...
        projects: {
            ...
            research: {
                cimav: {
                    ...
                    description: "Chatbot built with React and FastAPI that enables searches across all theses and papers related to doctors, professors, and students at CIMAV",
                    highlights: [
                        "Chatbot with a responsive and modern interface",
        ...
        projects: {
            ...
            research: {
                cimav: {
                    ...
                    description: "Chatbot développé avec React et FastAPI qui permet de rechercher dans toutes les thèses et articles liés aux docteurs, professeurs et étudiants du CIMAV",
                    highlights: [
                        "Chatbot avec une interface moderne et responsive",
